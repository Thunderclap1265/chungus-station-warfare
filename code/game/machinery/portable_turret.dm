...
/obj/machinery/porta_turret
	...
	var/health = 5000			//the turret's health
	var/maxhealth = 5000		//turrets maximal health.
	var/auto_repair = 1		//if 1 the turret slowly repairs itself.
	...
	var/shot_delay = 10		//1.5 seconds between each shot

	var/team = 0	//checks if the perp is set to arrest
...
/obj/machinery/porta_turret/chungus
	team = CHUNGUS_TEAM
	icon = 'icons/obj/chungusturrets.dmi'
/obj/machinery/porta_turret/noob
	team = NOOB_TEAM
	icon = 'icons/obj/noobturrets.dmi'
...
/obj/machinery/porta_turret/proc/assess_living(var/mob/living/L)
	...
	return TURRET_NOT_TARGET	//if the perp has passed all previous tests, congrats, it is now a "shoot-me!" nominee
