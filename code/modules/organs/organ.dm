...
/obj/item/organ/proc/take_damage(amount, var/silent=0)
	...
	to_chat(world, "taking organ damage: [amount]")
	if(owner.death_timer)
		to_chat(world, "death_timer: [owner.death_timer]")
		owner.death_timer -= amount
		to_chat(world, "post death_timer: [owner.death_timer]")
